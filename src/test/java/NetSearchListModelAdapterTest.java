...
public class NetSearchListModelAdapterTest {
    ...
    public void partialMatch1() {
        ...
        verify(listener).contentsChanged(
            refEq(new ListDataEvent(nslma, ListDataEvent.CONTENTS_CHANGED, 0, 4)));
    ...
    public void partialMatch2() {
        ...
        verify(listener).contentsChanged(
            refEq(new ListDataEvent(nslma, ListDataEvent.CONTENTS_CHANGED, 0, 2)));
        verifyNoMoreInteractions(listener);
