...
// WaveformPresentationModel.Listener stand-in, validates that the proper events were received.
class WaveformPresentationModelListener implements WaveformPresentationModel.Listener {
