...
public enum BitValue {
    ...
    public int toInt() { return (this == ONE) ? 1 : 0; }

    public static BitValue fromOrdinal(int ord) { return ORDINAL_TABLE[ord]; }
    ...
    public int compare(BitValue other) {
        if (this == ONE && other == ZERO) {
            ...
            // Either these are equal, or there is an X and Z, which match
            // everything.
            return 0;
        }
    }
